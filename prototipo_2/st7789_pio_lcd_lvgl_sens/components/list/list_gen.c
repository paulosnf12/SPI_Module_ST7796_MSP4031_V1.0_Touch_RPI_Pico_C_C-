...
lv_obj_t * list_create(lv_obj_t * parent)
{
    ...
    lv_obj_t * display_tela = lv_textarea_create(lv_obj_0);
    lv_obj_set_name(display_tela, "display");
    lv_obj_set_width(display_tela, lv_pct(100));
    lv_obj_set_height(display_tela, 50);
    lv_obj_set_style_text_align(display_tela, LV_TEXT_ALIGN_RIGHT, 0);
    ...
    lv_obj_add_event_cb(btn_0, generic_button_event_handler, LV_EVENT_CLICKED, display_tela);
    lv_obj_add_event_cb(btn_1, generic_button_event_handler, LV_EVENT_CLICKED, display_tela);
    lv_obj_add_event_cb(btn_2, generic_button_event_handler, LV_EVENT_CLICKED, display_tela);
    lv_obj_add_event_cb(btn_3, generic_button_event_handler, LV_EVENT_CLICKED, display_tela);
    lv_obj_add_event_cb(btn_4, generic_button_event_handler, LV_EVENT_CLICKED, display_tela);
    lv_obj_add_event_cb(btn_5, generic_button_event_handler, LV_EVENT_CLICKED, display_tela);
    lv_obj_add_event_cb(btn_6, generic_button_event_handler, LV_EVENT_CLICKED, display_tela);
    lv_obj_add_event_cb(btn_7, generic_button_event_handler, LV_EVENT_CLICKED, display_tela);
    lv_obj_add_event_cb(btn_8, generic_button_event_handler, LV_EVENT_CLICKED, display_tela);
    lv_obj_add_event_cb(btn_9, generic_button_event_handler, LV_EVENT_CLICKED, display_tela);
    lv_obj_add_event_cb(btn_w, generic_button_event_handler, LV_EVENT_CLICKED, display_tela);
    lv_obj_add_event_cb(btn_dbm, generic_button_event_handler, LV_EVENT_CLICKED, display_tela);
    lv_obj_add_event_cb(btn_point, generic_button_event_handler, LV_EVENT_CLICKED, display_tela);

    // Associe um callback diferente para o botão Enter
    lv_obj_add_event_cb(btn_enter, enter_button_event_handler, LV_EVENT_CLICKED, display_tela);
