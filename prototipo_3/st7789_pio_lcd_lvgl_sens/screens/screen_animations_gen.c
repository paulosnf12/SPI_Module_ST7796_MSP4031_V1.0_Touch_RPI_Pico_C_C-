...
lv_obj_t * screen_animations_create(void)
{
    ...
    lv_obj_set_x(botao_seta, 4);
    lv_obj_set_y(botao_seta, -5);
    lv_obj_set_width(botao_seta, 84);
    lv_obj_set_height(botao_seta, 41);
    ...
    lv_obj_set_x(button_list, 128);
    lv_obj_set_y(button_list, -51);
    lv_obj_set_width(button_list, 216);
    lv_obj_set_height(button_list, 265);
