...
var ASM_CONSTS = {
 ...
 166494: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 166577: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 166646: () => { return window.innerWidth; },  
 166676: () => { return window.innerHeight; }
};
